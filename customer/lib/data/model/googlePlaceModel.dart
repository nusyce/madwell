...
class GooglePlaceModel {
  ...
  factory GooglePlaceModel.fromMap(final Map<String, dynamic> map) =>
      GooglePlaceModel(
  ...
  @override
  String toString() =>
      "GooglePlaceModel(name: $name, cityName: $cityName, placeId: $placeId, latitude: $latitude, longitude: $longitude)";
