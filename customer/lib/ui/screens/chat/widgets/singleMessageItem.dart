...
class _SingleChatMessageItemState extends State<SingleChatMessageItem> {
      ...
      children: [
        Flexible(
          child: CustomContainer(
            ...
            borderRadiusStyle: BorderRadiusDirectional.only(
  ...
  Widget _buildImageMessageWidget({
    ...
    Widget singleImageItem(
        {required ChatMessage imageMessage, required int index}) {
        ...
        child: CustomContainer(
          ...
          child: imageMessage.isLocallyStored
              ...
              : CustomCachedNetworkImage(
                  networkImageUrl: imageMessage.files[index].fileUrl,
                  fit: BoxFit.contain),
        ),
      );
    }
                    ...
                    children: [
                      Expanded(
                        child: singleImageItem(
                            imageMessage: imageMessage, index: 0),
                      ),
                      if (imageMessage.files.length > 1 &&
                        ...
                        Expanded(
                          child: singleImageItem(
                              imageMessage: imageMessage, index: 1),
                        ),
                      ]
                    ],
                  ),
                        ...
                        if (imageMessage.files.length > 4) ...[
                          ...
                          Expanded(
                            child: Stack(
                              ...
                              children: [
                                singleImageItem(
                                    imageMessage: imageMessage, index: 4),
                                    ...
                                    onTap: () {
                                      Navigator.of(context).pushNamed(
                                        ...
                                        arguments: {
                                          ...
                                          "initialPage": 4,
                                          "userName": imageMessage.senderId ==
                                                  widget.senderId
                                              ? "you"
                                                  .translate(context: context)
                                              : widget.chatMessage.senderDetails
                                                  .name,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (fileMessage.message.trim().isNotEmpty &&
                            index == fileMessage.files.length - 1) ...[
                          const CustomSizedBox(
                            height: 5,
                          ),
                          CustomText(
  ...
  Widget _topNameTimeWidget() {
    return Padding(
      padding: EdgeInsetsDirectional.only(
          bottom: 2,
          end: widget.chatMessage.messageType == ChatMessageType.textMessage
              ? 0
              : 5,
          start: widget.chatMessage.messageType == ChatMessageType.textMessage
              ? 0
              : 5),
      child: Text(
