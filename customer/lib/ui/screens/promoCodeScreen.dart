      ...
      CustomContainer(
        ...
        child: Column(
          ...
          children: [
                      ...
                      Row(
                        children: [
                          CustomText(
                              ...
                              '${promoCodeDetails.discountType == "percentage" ? '%' : promoCodeDetails.discountType == "amount" ? context.read<SystemSettingCubit>().systemCurrency : promoCodeDetails.discountType}',
                              fontSize: 20,
            ...
            getMessageContainer(message: promoCodeDetails.translatedMessage!),
            getMessageContainer(
              message:
                  "${'offerIsApplicableOnMinimumValueOf'.translate(context: context)} ${promoCodeDetails.minimumOrderAmount!.priceFormat(context)}",
            ),
            getMessageContainer(
              message:
                  "${'maximumInstantDiscountOf'.translate(context: context)} ${promoCodeDetails.maxDiscountAmount!.priceFormat(context)}",
            ),
            getMessageContainer(
              message:
                    ...
                    ? Center(
                        child: NoDataFoundWidget(
                          titleKey: 'noPromoCodeAvailable'
                              .translate(context: context),
                          subtitleKey: 'noPromoCodeAvailableSubTitle'
                              .translate(context: context),
                        ),
                      )
                    : Column(
