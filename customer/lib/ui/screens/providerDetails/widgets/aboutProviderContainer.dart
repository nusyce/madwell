    ...
    return CustomContainerWithTitle(
      ...
      child: Padding(
        ...
        child: Theme(
          ...
          child: HtmlWidget(
            providerDetails.translatedLongDescription ?? "",
            textStyle: TextStyle(
  ...
  Widget ContactUsSection({
    ...
    return CustomContainerWithTitle(
      ...
      child: CustomInkWellContainer(
        onTap: () async {
          // Note: This opens map, not direct contact. If there's a direct contact action, it should be tracked separately
          // For now, tracking map/location view as contact action
          ClarityService.logAction(
            ClarityActions.serviceDetailContactTapped,
            {
