import 'package:edemand_partner/analytics/analytics_events.dart';
import 'package:edemand_partner/analytics/analytics_helper.dart';
import 'package:edemand_partner/analytics/analytics_ids.dart';
import 'package:edemand_partner/analytics/clarity_route_observer.dart';
import 'package:edemand_partner/analytics/google_analytics_route_observer.dart';
import 'package:edemand_partner/analytics/microsoft_clarity_initializer.dart';
...
class _AppState extends State<App> with WidgetsBindingObserver {
  ...
  void initState() {
    ...
    // Log app launch to both analytics platforms
    AnalyticsHelper.logEvent(ClarityActions.appLaunch);
  }
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    switch (state) {
      case AppLifecycleState.resumed:
        AnalyticsHelper.logEvent(ClarityActions.appResume);
        break;
      case AppLifecycleState.paused:
      case AppLifecycleState.detached:
      case AppLifecycleState.inactive:
      case AppLifecycleState.hidden:
        AnalyticsHelper.logEvent(ClarityActions.appBackground);
        break;
    }
  }
