  ...
  Future<void> getLanguageData({required AppLanguage languageData}) async {
    try {
      ...
      if (canUseCachedData) {
        ...
        AnalyticsHelper.setTag('language', languageData.languageCode);
        emit(
          GetLanguageDataSuccess(
      ...
      if (jsonData.isEmpty) {
        ...
        AnalyticsHelper.setTag('language', fallbackLanguage.languageCode);
        emit(
          GetLanguageDataSuccess(
      ...
      if (storedLanguage != null &&
        ...
        AnalyticsHelper.setTag('language', storedLanguage.languageCode);
        emit(
          GetLanguageDataSuccess(
            jsonData: storedJsonData,
            currentLanguage: storedLanguage,
