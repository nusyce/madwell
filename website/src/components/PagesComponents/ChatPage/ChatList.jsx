...
const ChatList = ({
  ...
  return (
    <div className={`w-full md:w-1/4 card_bg rounded-l-lg overflow-hidden chatListWrapper min-w-[270px] ${isRTL ? "border-l" : "md:border-r"
      }`}>
      ...
      <div
        className="h-[calc(100vh-230px)] sm:h-[600px] overflow-auto"
        ref={chatListRef}
